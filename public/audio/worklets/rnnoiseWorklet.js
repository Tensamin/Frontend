...
var Ze = (c, n, e) =>
  n in c
    ? Ke(c, n, { enumerable: !0, configurable: !0, writable: !0, value: e })
    : (c[n] = e);
var j = ((c) =>
  typeof require < "u"
    ? require
...
var Je = async () =>
  ...
  Pe = (() => {
    ...
    return function (e) {
            ...
            ? (s(!Q[r]),
              ...
              A === null &&
                ...
                (A = setInterval(function () {
                  ...
                  var o = !1;
                  for (var i in Q)
                    (o || ((o = !0), _("still waiting on run dependencies:")),
                      _("dependency: " + i));
                  o && _("(end of list)");
                }, 1e4)))
      ...
      ((e.FS_createDataFile = h.createDataFile),
        (e.FS_createPreloadedFile = h.createPreloadedFile));
      ...
      function Le() {
          ...
          return !H &&
            ...
            ? fetch(E, { credentials: "same-origin" }).then(function (w) {
                ...
                return P.then(d, function (v) {
                  return (
                    _("wasm streaming compile failed: " + v),
        ...
        if (e.instantiateWasm)
          try {
            ...
            return (
              _("Module.instantiateWasm callback failed with error: " + w),
              !1
            );
          }
        return (M().catch(u), {});
      ...
      function Be(r, o, i, d) {
        t(
          "Assertion failed: " +
            ee(r) +
            ", at: " +
            [o ? ee(o) : "unknown filename", i, d ? ee(d) : "unknown function"],
        );
      }
      function We(r, o, i) {
      ...
      var he = {
        __assert_fail: Be,
        emscripten_memcpy_big: We,
        emscripten_resize_heap: ze,
      };
      (Le(),
  ...
  q = class c {
    constructor(n) {
      ...
      ((this.rnnoiseModule = n),
        (this.frameSize = n._rnnoise_get_frame_size()));
    }
    static async load(n = {}) {
        ...
        Pe({
          locateFile: (p, u) => (
            ...
            n.wasmFileName !== void 0
              ? ((p = n.wasmFileName),
                console.debug("Loads rnnoise-wasm: ", u + p))
              : a
                ? ((p = "rnnoise_simd.wasm"),
                  console.debug("Loads rnnoise-wasm (SIMD ver): ", u + p))
  ...
  pe = class {
    constructor(n, e) {
      ...
      let a;
      e !== void 0
        ? (a = this.rnnoiseModule._rnnoise_create(e.model))
        : (a = this.rnnoiseModule._rnnoise_create());
      let p = this.rnnoiseModule._malloc(this.frameSize * Z),
        u = this.rnnoiseModule._malloc(this.frameSize * Z);
      if (!a || !p || !u)
        throw (
          this.destroy(),
          Error("Failed to allocate DenoiseState or PCM buffers.")
        );
      ((this.state = a), (this.pcmInputBuf = p), (this.pcmOutputBuf = u));
    }
    processFrame(n) {
      if (this.rnnoiseModule === void 0)
        throw Error("This denoise state has already been destroyed.");
      if (n.length != this.frameSize)
        throw Error(
          `Expected frame size ${this.frameSize}, but got ${n.length}`,
        );
      let e = this.pcmInputBuf / Z,
        a = this.pcmOutputBuf / Z;
      this.rnnoiseModule.HEAPF32.set(n, e);
      let p = this.rnnoiseModule._rnnoise_process_frame(
        this.state,
        this.pcmOutputBuf,
        this.pcmInputBuf,
      );
      return (
        n.set(this.rnnoiseModule.HEAPF32.subarray(a, a + this.frameSize)),
        p
      );
    }
    destroy() {
...
var $e = (c) => {
  ...
  me = (c, { bufferSize: n, maxChannels: e }) => {
    if (c.frameSize !== 480)
      throw new Error(`rnnoise frameSize must be 480. (was ${c.frameSize})`);
    ...
    constructor(e) {
      ...
      (this.port.addEventListener("message", (a) => {
        ...
        (async () => {
          ...
          ((this.processor = me(a, {
            bufferSize: et,
            maxChannels: e.processorOptions.maxChannels,
          })),
    ...
    process(e, a, p) {
      return (
        e.length === 0 ||
          ...
          e[0]?.length === 0 ||
          !this.processor ||
          this.processor.process(e[0], a[0]),
        !0
      );
    }
    destroy() {
...
@shiguredo/rnnoise-wasm/dist/rnnoise.mjs:
   ...
   **)
*/
//# sourceMappingURL=rnnoiseWorklet.js.map
