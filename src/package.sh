...
# Arch
#cp "$PWD/dist/tensamin-frontend-$npm_package_version.tar.xz" ./release/aur/amd64.tar.xz
#cp "$PWD/dist/tensamin-frontend-$npm_package_version-arm64.tar.xz" ./release/aur/arm64.tar.xz
echo Packaged!